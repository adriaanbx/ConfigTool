...
{
    public class EcmParameterWrapper : ModelWrapper<Ecmparameter, int>
    {
        public int? TagId
        {
        ...
        public EcmParameterWrapper(Ecmparameter model) : base(model)
        {
        }
        ...
        protected override IEnumerable<string> ValidateProperty(string propertyName)
        {
            switch (propertyName)
            {
                case nameof(DefaultValue):
                    ...
                    {
                        yield return "Test is not a valid EcmParametertag";
                    }
                    break;
            }
        }
