...
{
    public class ToolingParameterTableViewModel : TableViewModelBase<ToolingParameter, int, ToolingParameterWrapper>, IToolingParameterTableViewModel
    {
        ...
        public ToolingParameterTableViewModel(IToolingParameterRepository toolingParameterRepository, IPlctagRepository plctagRepository,
                                   IValueTypeRepository valueTypeRepository, IReadWriteTypeRepository readWriteTypeRepository,
                                   ITextLanguageRepository textLanguageRepository, ITextLanguageRepository groupTextLanguageRepository, IEventAggregator eventAggregator, IMessageDialogService messageDialogService) : base(toolingParameterRepository, eventAggregator, messageDialogService)
        {
        ...
        protected override bool FilterTags(object obj)
        {
            ...
            if (obj is ToolingParameterTableItem tableItem)
            {
                ...
                return tableItem.Table.Enable.Contains(TableFilter, StringComparison.InvariantCultureIgnoreCase) ||
                       tableItem.Table.DefaultValue.Contains(TableFilter, StringComparison.InvariantCultureIgnoreCase) ||
