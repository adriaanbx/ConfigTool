...
{
    public class RecipeParameterTableViewModel : TableViewModelBase<RecipeParameter, int, RecipeParameterWrapper>, IRecipeParameterTableViewModel
    {
        ...
        protected override bool FilterTags(object obj)
        {
            ...
            if (obj is RecipeParameterTableItem tableItem)
            {
