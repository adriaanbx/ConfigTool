...
{
    public class EcmParameterTableViewModel : TableViewModelBase<Ecmparameter, int, EcmParameterWrapper>, IEcmParameterTableViewModel
    {
        ...
        public EcmParameterTableViewModel(IEcmParameterRepository ecmParameterRepository, IPlctagRepository plctagRepository,
                                   IValueTypeRepository valueTypeRepository, IReadWriteTypeRepository readWriteTypeRepository,
                                   ITextLanguageRepository textLanguageRepository, ITextLanguageRepository groupTextLanguageRepository, IEventAggregator eventAggregator, IMessageDialogService messageDialogService) : base(ecmParameterRepository, eventAggregator, messageDialogService)
        {
        ...
        protected override bool FilterTags(object obj)
        {
            ...
            if (obj is EcmParameterTableItem tableItem)
            {
